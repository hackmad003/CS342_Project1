...
public class HMTest {
	...
	void testHMConstructorInteger() {
		...
		assertEquals(Integer.valueOf(651397101), map.get("Ahmad"));
	...
	void testPutCollision() {
		...
		for(int i = 1; i <= 10; i++) {
			assertTrue(map.contains("key_" + i), "All keys should be accessible after collisions");
	...
	public void testPutAllowsDuplicates() {
		MyHashMap<String> map = new MyHashMap<>("key1", "a");
	     ...
	     assertTrue(map.contains("key1")); //b is now lost but this is a simplified hashmap per instructions
	    }
	...
	void testSizeMethod() {
		MyHashMap<String> map = new MyHashMap<>("key_1", "val_1");
		assertEquals(1, map.size(), "Initial size should be 1");
		map.put("key_2", "val_2");
		assertEquals(2, map.size(), "Size should be 2 after adding one element");
		map.put("key_3","val_3");
		map.put("key_4", "val_4");
		assertEquals(4, map.size(), "Size should be 4 after adding 3 elements");
	}
	...
	void testIsEmptyMethod() {
		MyHashMap<String> map = new MyHashMap<>("key_1", "val_1");
		assertFalse(map.isEmpty(), "Map with initial element should not be empty");
		map.put("key_2", "val_2");
		assertFalse(map.isEmpty(), "Map with multiple elements should not be empty");
	}
    ...
    void testForEachLoop() {
    	...
    	ArrayList<String> collectedVals = new ArrayList<>();
	...
	void testHashCollisions() {
		...
		for(int i = 1; i <= 20; i++) {
			...
			assertEquals("val_" + i, map.get("key_" + i), "All values should be correct after many insertions");
		}
	}
	...
	void testMyHashMapDataStructure() {
		...
		ArrayList<Double> allStudentGrades = new ArrayList<>();
