...
public class GQTest {
    ...
    /////////////////////////////////
    //// GenericList Method Tests ///
    /////////////////////////////////
    
    
    @Test
    public void testNodeConstructor() {
    	GenericList.Node<String> node = new GenericList.Node<>("hello", 101);
    ...
    public void testNodeConstructorWithoutCode() {
        GenericList.Node<Integer> node = new GenericList.Node<>(99);
    ...
    @Test
    void testGetLengthMethod() {
        GenericQueue<String> queue = new GenericQueue<>("test");
        assertEquals(1, queue.getLength());
    }

    @Test
    void testSetLengthMethod() {
        GenericQueue<String> queue = new GenericQueue<>("test");
        queue.setLength(5);
    ...
    @Test
    void testGenericQueueConstructor() {
        GenericQueue<String> queue = new GenericQueue<>("hello");
        
        assertEquals(1, queue.getLength());
        assertEquals("hello", queue.getHead().data);
        assertEquals(0, queue.getHead().code);
        assertNull(queue.getHead().next);
    }
    ...
    public void testGLLIterator() {
        ...
        GLLIterator<Integer> gllIter = new GLLIterator<>(queue.getHead());
        
        ArrayList<Integer> collected = new ArrayList<>();
        while (gllIter.hasNext()) {
            collected.add(gllIter.next());
        }
    ...
    public void testReverseGLLIterator() {
        ...
        ReverseGLLIterator<Integer> reverseIter = new ReverseGLLIterator<>(queue.getHead());
        
        ArrayList<Integer> collected = new ArrayList<>();
        while (reverseIter.hasNext()) {
            collected.add(reverseIter.next());
        }
        
        assertEquals(3, collected.size());
        assertEquals(3, collected.get(0));
        assertEquals(2, collected.get(1));
        assertEquals(1, collected.get(2));
    }
